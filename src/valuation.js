...
setTimeout(() => set('[data-output="estimate-range"]', estimateRange), 100);
setTimeout(() => set('[data-output="estimate-range"]', estimateRange), 500);
setTimeout(() => set('[data-output="estimate-range"]', estimateRange), 1000);
